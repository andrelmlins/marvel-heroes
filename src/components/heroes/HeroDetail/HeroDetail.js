...
class HeroDetail extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      description: props.hero.details
        ? props.hero.details.description === ""
    ...
    return (
      <div>
        {this.props.hero.thumbnail && (
          ...
          >
            <h4>
              <strong>{this.props.hero.name}</strong>
            </h4>
            <br />
            <Button className="blue m-r-10" onClick={() => this.clickEdit()}>
              Edit Hero
            </Button>
            {this.props.hero.urls &&
              this.props.hero.urls.map((item, index) => {
                return (
                  <a
                    href={item.url}
                    target="_blank"
                    ...
                    key={index}
                  >
                    <Button className="red m-r-10">{item.type}</Button>
                  </a>
                );
              })}
          </Card>
            ...
            <Tab title="Details" active>
              <Card>
                <p>
                  ...
                  {this.props.hero.details
                    ? this.props.hero.details.superpower
                    : ""}
                </p>
                <p>
                  <strong>Group:</strong>{" "}
                  {this.props.hero.details ? this.props.hero.details.group : ""}
                </p>
                <p>
                  <strong>Biography:</strong>{" "}
                  {this.props.hero.details
                    ? this.props.hero.details.biography
                    : ""}
                </p>
                <p>
                  <strong>Description:</strong>{" "}
                  {this.props.hero.details ? this.state.description : ""}
                </p>
              </Card>
            </Tab>
        ...
        <Card style={{ display: this.props.edit ? "block" : "none" }}>
          ...
          <div className="right">
            <Button className="grey" onClick={() => this.clickCancel()}>
              Cancel
            </Button>
            &emsp;
            <Button className="red" onClick={() => this.submitEdition()}>
              Submit Edition
            </Button>
          </div>
          <br />
